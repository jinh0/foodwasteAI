...
# 3 Variables + output, Linear Regression Model

fprintf('Student Prediction v0.1\n');
fprintf('Using rice and dal data\n\n');
...
X_predict = X(random, 2:4)
y_predict = y(random);
prediction = [1, X_predict] * theta;

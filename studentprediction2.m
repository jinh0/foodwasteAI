...
degrees = input('Degree of polynomial variables: ');
...
fprintf('Predictions against TRAINING Data Visualization:\n');
...
fprintf('Predictions against TEST Data Visualization:\n\n');
